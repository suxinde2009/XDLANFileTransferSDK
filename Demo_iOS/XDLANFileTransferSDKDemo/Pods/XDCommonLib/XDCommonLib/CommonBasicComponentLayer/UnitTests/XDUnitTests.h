...
//#define XDUnitTest(c) c##UnitTest
//
//struct testName {
...
//interface XDUnitTest(name) : NSObject @end \
...
//static void name##Register(void) { registerTestClass([XDUnitTest(name) class]); } \
//@implementation XDUnitTest(name) \
//__VA_ARGS__ \
