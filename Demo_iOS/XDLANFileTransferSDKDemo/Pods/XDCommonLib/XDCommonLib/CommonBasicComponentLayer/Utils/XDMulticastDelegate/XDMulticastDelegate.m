...
@interface XDMulticastDelegateNode : NSObject {
@private
...
@interface XDMulticastDelegateEnumerator ()
{
    NSUInteger numNodes;
...
@implementation XDMulticastDelegate
...
- (void)addDelegate:(id)delegate delegateQueue:(dispatch_queue_t)delegateQueue
{
    ...
    XDMulticastDelegateNode *node =
    [[XDMulticastDelegateNode alloc] initWithDelegate:delegate delegateQueue:delegateQueue];
...
- (void)removeDelegate:(id)delegate delegateQueue:(dispatch_queue_t)delegateQueue
{
    ...
    {
        XDMulticastDelegateNode *node = [delegateNodes objectAtIndex:(i-1)];
...
{
    for (XDMulticastDelegateNode *node in delegateNodes)
    {
        node.delegate = nil;
#if __has_feature(objc_arc_weak) && !TARGET_OS_IPHONE
        node.unsafeDelegate = nil;
...
- (XDMulticastDelegateEnumerator *)delegateEnumerator
{
    return [[XDMulticastDelegateEnumerator alloc] initFromDelegateNodes:delegateNodes];
}
...
@implementation XDMulticastDelegateNode
...
@implementation XDMulticastDelegateEnumerator
...
- (BOOL)getNextDelegate:(id *)delPtr delegateQueue:(dispatch_queue_t *)dqPtr
{
    ...
    {
        XDMulticastDelegateNode *node = [delegateNodes objectAtIndex:currentNodeIndex];
        currentNodeIndex++;
