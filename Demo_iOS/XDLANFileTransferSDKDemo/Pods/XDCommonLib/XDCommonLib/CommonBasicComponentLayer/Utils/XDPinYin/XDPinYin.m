...
+ (NSString *)quickConvert:(NSString *)hzString {
    ...
    //  cache
    if (cache == NULL) {
        int pycount = sizeof(pinyinTable) / sizeof(XDPinyinTableCell);
        
        if (cacheCeil == 0 && cacheFloor == 0xffffffff) {
            unsigned int max = 0, min = 0xffffffff;
            for (int i = 0; i < pycount; i++) {
                XDPinyinTableCell pycell = pinyinTable[i];
                NSString *hz = pycell.hanzi;
                NSInteger hzCount = [hz length];
        ...
        cache = malloc(cacheLength * sizeof(XDPinyinTableCell *));
    ...
    NSInteger hzLength = [hzString length];
    ...
    for (int i = 0; i < hzLength; i++) {
        ...
        XDPinyinTableCell pycell = pinyinTable[pos];
