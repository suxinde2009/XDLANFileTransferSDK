...
#import "NSFileManager+XD_Handy.h"
#import <sys/xattr.h>

@implementation NSFileManager (XD_Handy)
...
{
    return [[NSFileManager pathForApplicationSupportDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[NSFileManager pathForCachesDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[NSFileManager pathForDocumentsDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[NSFileManager pathForLibraryDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[NSFileManager pathForMainBundleDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[NSFileManager pathForTemporaryDirectory] stringByAppendingPathComponent:path];
}
