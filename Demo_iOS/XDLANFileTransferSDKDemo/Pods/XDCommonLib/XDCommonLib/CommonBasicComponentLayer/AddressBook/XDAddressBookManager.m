...
{
    return [XDAddressBookManager findContactWithPhoneNumber:phoneNumber].name;
}

+ (UIImage *)photoForContactWithPhoneNumber:(NSString *)phoneNumber
{
    return [XDAddressBookManager findContactWithPhoneNumber:phoneNumber].photo;
}
