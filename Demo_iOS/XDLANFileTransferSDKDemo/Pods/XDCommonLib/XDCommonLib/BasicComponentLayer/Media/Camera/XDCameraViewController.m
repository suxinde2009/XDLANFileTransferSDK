...
@interface XDCameraViewController ()
...
@implementation XDCameraViewController
...
- (void)createFunctionalUI
{
    ...
    //闪光灯开启关闭按钮
    UIButton *flashBtn=[[UIButton alloc]initWithFrame:CGRectMake(CGRectGetMinX(_shutterBtn.frame), 100, 40, 30)];
    ...
    //切换前后摄像头
    UIButton *shiftBtn=[[UIButton alloc]initWithFrame:CGRectMake(CGRectGetMinX(_shutterBtn.frame), 170, 40, 30)];
